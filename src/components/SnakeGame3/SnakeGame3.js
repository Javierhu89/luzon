...
class SnakeGame3 extends React.Component {
  constructor(props) {
    super(props)
  ...
  tryToEatApple() {
    ...
    let rock = this.state.rock
    let numFoll = this.state.numFoll
    ...
    if (snake[0].Xpos === apple.Xpos && snake[0].Ypos === apple.Ypos) {
      ...
      // increment high score if needed
        Score = Score + 3;
        Score2 = Score2 + 3;
        if(Score2>13&&Score2<27){
          this.setState({'imagen':'1'})
        } else if(Score2>27&&Score2<40){
          this.setState({'imagen':'2'})
        } else if(Score2>40&&Score2<54){
...
//teclas - números, asignar clicks a diferentes teclas
  ...
  render() {
    ...
    <div className="dpad">
      ...
      return ( <div><div className="gameboy agrandar" id="GameBoy">
      <div className="screen-area agrande"> 
      <canvas className="display pantalla" id="mainCanvas"></canvas>
      <div className="label">
      <div className="title">ELA </div>
    ...
    <div className="screen-area">
      <div
        ...
        {this.state.snake.map((snakePart, index) => {
          if(index!=0){
            ...
            <img alt ='Papeles logrados'
              ...
              }} src={process.env.PUBLIC_URL + 'assets/img/folleto.png'}
            />
            )} else {
              return (
        ...
        <img className='Block' alt='Icono de Folletos'
          style={{
            width: this.state.blockWidth,
            height: this.state.blockHeight,
